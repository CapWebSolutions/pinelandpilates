...
function genesis_sample_woocommerce_styles( $enqueue_styles ) {
	...
	$enqueue_styles['pineland-woocommerce-styles'] = array(
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/pineland-woocommerce.css',
		'deps'    => '',
...
function genesis_sample_woocommerce_css() {
	...
	if ( $woo_css ) {
		wp_add_inline_style( 'pineland-woocommerce-styles', $woo_css );
	}
